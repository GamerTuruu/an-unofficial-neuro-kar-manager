...
| Software                                                                       | License                                                                                                           |
|--------------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------------------------|
| [Tauri](https://github.com/tauri-apps/tauri)                                   | [MIT/Apache](https://github.com/tauri-apps/tauri/blob/dev/LICENSE_MIT)                                            |
| [Rclone](https://github.com/rclone/rclone)                                     | [MIT](https://github.com/rclone/rclone/blob/master/COPYING)                                                       |
| [Rclone UI](https://github.com/rclone-ui/rclone-ui)                            | [Apache 2.0](https://github.com/rclone-ui/rclone-ui/blob/main/LICENSE)                                            |
